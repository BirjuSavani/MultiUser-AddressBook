...
<script RunAt="server">
    ...
    //LoginPage
        ...
        routes.MapPageRoute("AdminPanelLogin", "AdminPanel/Login/List", "~/AdminPanel/Login/Login.aspx");

    //SignUpPage

        routes.MapPageRoute("AdminPanelSignUp", "AdminPanel/SignUp/List", "~/AdminPanel/Login/SignUp.aspx");

    // Default

        routes.MapPageRoute("AdminPanelDefault", "AdminPanel/Default/List", "~/AdminPanel/Default.aspx");
